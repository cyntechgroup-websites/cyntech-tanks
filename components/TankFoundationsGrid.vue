...
const galleryImages = [
  {
    ...
    shortDescription: "Cost effective foundation.",
    longDescriptionSlides: [
      "Gravel ringwall is a more cost-effective foundation for settling tanks. Along with tank move or tank lifts, we can remove and replace the existing foundation with a sound gravel ringwall.",
    ],
  },
  {
    src: "/images/reinforced-ring-wall.webp",
    title: "Reinforced Ring Wall",
    shortDescription: "More sound option to tank settlement.",
    longDescriptionSlides: [
      "Reinforced Concrete Ringwall is a more sound solution to tank settlement. Our civil engineers are experts and can design and draft an optimal ringwall for a variety of site conditions.",
    ],
  },
  {
    src: "/images/helical-piles.webp",
    title: "Reinforced Ring Helical Piles",
    shortDescription: "Deep foundation solution for tanks that are founded on undesirable bases.",
    longDescriptionSlides: [
      "In addition to our reinforced concrete ringwalls, we team up with our Anchor Division and combine a deep foundation solution for tanks that are founded on undesirable bases.",
    ],
  },
  {
    src: "/images/grout-injection.webp",
    title: "Grout Injection",
    shortDescription: "Cost-effective soft foundation.",
    longDescriptionSlides: [
